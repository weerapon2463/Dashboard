...
const OV_RENDER = {
  ...
  about() {
    return `<p>Production Dashboard เชื่อมงานทุกฝ่ายของโรงงานไว้ในที่เดียว: คำสั่งซื้อ → วางแผน → ใบสั่งผลิต → BOM หลายระดับ → เบิกวัสดุ/คลัง → จัดซื้อ PR→PO → คุณภาพ → ส่งมอบ → บริการหลังการขายและเคลม พร้อมสิทธิ์ตามกลุ่มผู้ใช้ ประวัติการใช้งาน รายงานตามผู้อ่าน และการตรวจความสอดคล้องของข้อมูลข้ามโมดูล</p>`;
  },
};
